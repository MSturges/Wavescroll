...
$(document).ready(function() {
  ...
  function changePages() {
    ...
    TweenLite.to(".ws-bg__part-" + index, changeAT, {
      y: y
    });

    for (var i = leftMax; i > 0; i--) {
      var d = (index - i) * waveStagger;
      TweenLite.to(".ws-bg__part-" + i, changeAT - d, {
        y: y,
        delay: d
      });
    }
    ...
    for (var j = rightMin; j <= bgParts; j++) {
      ...
      TweenLite.to(".ws-bg__part-" + j, changeAT - d, {
        y: y,
        delay: d
      });
    }

    TweenLite.to($headings, changeAT, {
      y: textY
    });
  };
  ...
  function waveChange() {
    ...
    for (var i = 1; i <= bgParts; i++) {
      ...
      TweenLite.to(".ws-bg__part-" + i, changeAT, {
        y: y,
        delay: d
      });
    }
